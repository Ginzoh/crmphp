                                                        ...
                                                        <td><?php echo $row['email'];?></td>
                                                         <td><?php echo $row['mobile'];?></td>
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           ...
                                                           <a type="button" class="btn btn-primary btn-xs btn-mini"href="edit-user.php?id=<?php echo $row['id']; ?>" > Edit </a>
                                                           <a type="button" class="btn btn-danger btn-xs btn-mini"href="delete.php?id=<?php echo $row['id']; ?>" >Delete </a>
