          ...
          <div class="col-md-3 col-sm-6 spacing-bottom">
            <div class="tiles black added-margin">
              <div class="tiles-body">
                ...
                <div class="heading">  <span class="glyphicon glyphicon-book"></span>
                 <a href="view-animals.php" style="color:#FFF">My Animals</a>
                 </div>
                <div class="progress transparent progress-white progress-small no-radius">
                  <div class="progress-bar progress-bar-white animate-progress-bar" data-percentage="45%" ></div>
                </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="tiles purple added-margin">
              <div class="tiles-body">
                ...
                <div class="row-fluid">
                  <div class="heading"> <span class="fa fa-ticket"></span>
                  <a href="create-ticket.php" style="color:#FFF">Create ticket</a>
                   </div>
                  <div class="progress transparent progress-white progress-small no-radius">
