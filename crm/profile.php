...
if(isset($_POST['update']))
{
	...
	$a=mysqli_query($con,"update user set name='$name',mobile='$mobile',gender='$gender',email='$email',alt_email='$aemail',address='$address' where email='".$_SESSION['login']."'");
    $b=mysqli_query($con,"update animal set email_id='$email' where email_id='".$_SESSION['login']."'");
    $c=mysqli_query($con,"update ticket set email_id='$email' where email_id='".$_SESSION['login']."'");
